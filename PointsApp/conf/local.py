...
DATABASES = read_json('db_conection_dev_user.json',
                      os.path.join(BASE_DIR, 'conf/db_conection/'))
...
# User Notifications
WELCOME_EMAIL_ID_CONFIG = 1
NOTIFICATION_COMPLETED = 2
NOTIFICATION_ERROR = 3
NOTIFICATION_PENDING = 1
NOTIFICATION_IN_PROCESS = 4
